 ...
 * chunk on a `model.call.completed` event. `costCents` is always absent (no pricing table ships);
 * callers treat its absence as "cost unknown" and the Cost&Policy pane renders `$0.00` defaults.
 */
