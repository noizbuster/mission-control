...
const readRegistration: ToolRegistration<{ q: string }, { a: string }> = {
    ...
    parametersJsonSchema: { type: 'object', properties: { q: { type: 'string' } }, required: ['q'], additionalProperties: false },
...
const bashRegistration: ToolRegistration<{ cmd: string }, { out: string }> = {
    ...
    parametersJsonSchema: { type: 'object', properties: { cmd: { type: 'string' } }, required: ['cmd'], additionalProperties: false },
